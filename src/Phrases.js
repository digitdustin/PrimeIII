...
var NumberOfPhrasesInPrimeIII = 154; //Prime III has this number of phrases
...
Phrase[ENGLISH][150] = "Your selection is printing."; //Your selection is printing.
Phrase[ENGLISH][151] = "You are done voting"; //You are done voting.
Phrase[ENGLISH][152] = "Confirm your selection is correct."; //Confirm your selection is correct.
Phrase[ENGLISH][153] = "Touch your selection to continue."; //Touch your selection to continue printing.
Phrase[ENGLISH][154] = "To print your selections, "; //To print your selections, 
...
Phrase[SPANISH][150] = "Tu selección está imprimiendo."; //Your selection is printing.
Phrase[SPANISH][151] = "Has terminado de votar."; //You are done voting.
Phrase[SPANISH][152] = "Confirma que tu selección es correcta."; //Confirm your selection is correct
Phrase[SPANISH][153] = "Toque su selección para continuar imprimiendo."; //Touch your selection to go to the next contest.
Phrase[SPANISH][154] = "Para imprimir sus selecciones, "; //To print your selections, 
...
Phrase[CHINESE][150] = "打印我的选择"; //Print my selection(s) but should be Your selection is printing.
Phrase[CHINESE][151] = "打印我的选择"; //Print my selection(s) but should be You are done voting.
Phrase[CHINESE][152] = "打印我的选择"; //Print my selection(s) but should be Touch your selection to go to the next contest.
Phrase[CHINESE][153] = "打印我的选择"; //Print my selection(s) but should be Touch your selection(s) to continue printing.
Phrase[CHINESE][154] = "打印我的选择, "; //To print your selections, 
...
Phrase[CHINESE_T][150] = "打印我的选择"; //Print my selection(s) but should be Your selection is printing.
Phrase[CHINESE_T][151] = "打印我的选择"; //Print my selection(s) but should be You are done voting.
Phrase[CHINESE_T][152] = "打印我的选择"; //Print my selection(s) but should be Touch your selection to go to the next contest.
Phrase[CHINESE_T][153] = "打印我的选择"; //Print my selection(s) but should be Touch your selection(s) to continue printing.
Phrase[CHINESE_T][154] = "打印我的选择, "; //To print your selections, 
...
Phrase[CREOLE][150] = "Your selection is printing"; //Your selection is printing.
Phrase[CREOLE][151] = "You are done voting."; //You are done voting.
Phrase[CREOLE][152] = "Confirm your selection is correct."; //Confirm your selection is correct
Phrase[CREOLE][153] = "Touch your selection to continue."; //Touch your selection to continue.
Phrase[CREOLE][154] = "To print your selections, "; //To print your selections, 
