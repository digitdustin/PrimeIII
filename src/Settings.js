...
var PrintThe = "Ballot"; //Ballot, QRCode, BallotAndQRCodeAndQRCodeText, BallotAndQRCode, Download, BallotWithOvals, BallotWithOvalsLeftRight, Ovals, Nothing
var AllowVotersToSelectAudio = false;
var UseAudio = false;
var MicIsOn = false;
var UseTallyMode = false;
var ReviewMode = "Review"; //ByPass, Review, ReadOnly
var DownloadAs = "xml"; //xml or txt
...
var UseVoteByParty = false; //July 1, 2016
var TIPIDelay = 5000; //Timeout delay for allowing printer to print and then hide the screen
var UseEyeTrackers = false; 
var TIPIFontSize = 6; //This should not be less than 5. 5,6,7, etc.
var UseZoom = true;
var AllowOverVotes = false; 
var DeselectCandidates = true;
...
var PrintCandidatePhoto = false;
var RotateCandidates = 0; //Ohio uses this
...
var TIPINextButtonFont = "font: bold 24px Arial;width:700;height:100";
var StartAndNextButtonFont = "font: bold 24px Arial;width:500;height:100";
...
var elapsedTime = 0;
var VoiceName = "Google US English"; //"US English Female TTS (by Google)" or "Alex" or "Google US English" or "Google español" or "native";
...
function Candidate(id, cname, party, contest, photo, soundslike, left, top, line)
{
	...
	if (!PrintCandidatePhoto)
		this.CandidatePhoto = "none";
	else if ((photo != "none") && (photo.trim().length > 0) && (!EnableScreenReading))
	{
		var img=new Image();
    	img.src=photo;	
...
{//Proposition or Amendment
	...
	if ((ctype != "Contest") || (typeof(rtc) == 'undefined'))
